...
>('news/fetchNews', async ({ page, pageSize }) => {
	const response = await axios.get(
		`http://localhost:3002/news/all?page=${page}&pageSize=${pageSize}`
	)
...
>('news/fetchTopNews', async ({ page, pageSize }) => {
	const response = await axios.get(
		`http://localhost:3002/news/top?page=${page}&pageSize=${pageSize}`
	)
...
>('news/deleteNews', async ({ newsId, topNews, currentPage, pageSize }) => {
	const response = await axios.delete(
		`http://localhost:3002/news/delete/${newsId}?topNews=${topNews}&currentPage=${currentPage}&pageSize=${pageSize}`
	)
	return response.data
})
...
>('news/editNews', async ({ editedData, topNews, currentPage, pageSize }) => {
	...
	const response = await axios.put(
		`http://localhost:3002/news/edit/${editedData._id}?topNews=${topNews}&currentPage=${currentPage}&pageSize=${pageSize}`,
		formData
	)
	return response.data
})
